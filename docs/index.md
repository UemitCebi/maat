---
title: CodeDoc Documentation
status: current
summary: Entry point and map for the CodeDoc documentation set.
---
...
- [Check engine module](architecture/modules/check.md) — The validation rules behind `codedoc check` — the CI gate.
...
- [Architecture Overview](architecture/overview.md) — How CodeDoc is built — the CLI pipeline, the docs model, and the generate/validate split.
...
- [Adopting CodeDoc in a repository](guides/deployment.md) — How to add CodeDoc to an existing project and wire it into CI.
- [Development guide](guides/development.md) — How to set up, run, and contribute to CodeDoc locally.
- [Testing guide](guides/testing.md) — How to run and write CodeDoc's tests, and what CI enforces.
- [Troubleshooting](guides/troubleshooting.md) — Common codedoc check failures and how to resolve them.

### Reference — factual surface (config, env, API)

- [CLI reference](reference/cli.md) — Every codedoc command, flag, and exit code.
- [Configuration reference](reference/configuration.md) — Every .codedoc.yml key, its default, and its effect.
- [Environment variables](reference/environment.md) — Environment variables CodeDoc reads.
...
- [Glossary](meta/glossary.md) — Definitions of CodeDoc's domain terms.
